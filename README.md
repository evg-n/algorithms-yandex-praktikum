...
## Link to the course
[Algorithms and data structures](https://practicum.yandex.ru/algorithms/) (only available in Russian language).
...
* [Task L: Common longest sequence](sprint_4/i_common_longest_sequence.py)
* [Task J: Find unique quadriplets](sprint_4/j_find_unique_fours.py)
* [Task K: Nearest bus-station](sprint_4/k_nearest_bus_stations.py)
* [Task L: Find n-length k-occurrences substrings indexes](sprint_4/l_find_substrings_with_k_occurrences.py)
...
* [Task H: Numeric pathways sum](sprint_5/h_numeric_pathways.py)
...
* [Task N: Split BST](sprint_5/n_split_bst.py)
* [Final task A: Heap sort](sprint_5/final_a_heap_sort.py)
* [Final task B: Remove node in BST](sprint_5/final_b_bst_remove_node.py)

## Sprint 6: Graphs.

* [Task A: Adjacency list](sprint_6/a_adjacency_list.py)
* [Taks B: Adjacency matrix](sprint_6/b_adjacency_matrix.py)
* [Task C: DFS](sprint_6/c_dfs.py)
* [Task D: BFS](sprint_6/d_bfs.py)
* [Task E: Linked components](sprint_6/e_linked_components.py)
* [Task F: Distance between vertices](sprint_6/f_distance_between_vertices.py)
* [Task G: Most distant vertex](sprint_6/g_most_distant_vertex.py)
...
* [Task M: Bipartite graph checking](sprint_6/m_bipartite_graph.py)
...
* [Task D: Fibo DP](sprint_7/d_fibo_dp.py)
* [Task E: Nominals Target](sprint_7/e_nominals_target.py)
